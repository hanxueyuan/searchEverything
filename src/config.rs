...
fn default_mode() -> String { "glob".to_string() }
...
fn default_time_format() -> String { "iso".to_string() }
...
fn default_update_strategy() -> String { "auto".to_string() }
fn default_update_interval() -> u64 { 300 }
...
fn default_max_memory() -> usize { 512 }
...
fn default_skill_name() -> String { "searchEverything".to_string() }
fn default_command_prefix() -> String { "searchEverything".to_string() }
...
fn default_regex_engine() -> String { "rust".to_string() }
